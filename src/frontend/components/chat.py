    ...
    async def send_message(self, user_message: str) -> str:
        ...
        try:
            ...
            response = await self.api_client.send_chat_message(
                ...
                context={"user_id": auth_state.user_info.get("user_id") if auth_state.user_info else None}
            )
    ...
    with gr.Blocks(
        ...
        with gr.Column(elem_classes=["chat-container"]):
            ...
            with gr.Row(elem_classes=["chat-header"]):
                ...
                gr.Markdown("Ask me anything about your Azure DevOps projects, work items, repositories, and pipelines!")
